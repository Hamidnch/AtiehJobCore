...
namespace AtiehJobCore.Core.Infrastructure
{
    ...
    public class CommonEngine : IEngine
    {
        ...
        /// </summary>
        /// <param name="grandConfiguration">Startup AtiehJob configuration parameters</param>
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            AtiehJobMapperConfiguration.RegisterMongoDbMappings(grandConfig);

            //initialize plugins
            var mvcCoreBuilder = services.AddMvcCore();
            PluginManager.Initialize(mvcCoreBuilder.PartManager, grandConfig);

            //initialize CTX scripts
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new AtiehJobException("Unknown dependency");
                        return service;
                    });
                ...
                catch (AtiehJobException) { }
            }
            throw new AtiehJobException("No constructor was found that had all the dependencies satisfied.");
        }
