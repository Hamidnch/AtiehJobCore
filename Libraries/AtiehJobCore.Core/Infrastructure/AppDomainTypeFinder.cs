...
namespace AtiehJobCore.Core.Infrastructure
{
    ...
    /// referenced by <see cref="P:AtiehJobCore.Core.Infrastructure.AppDomainTypeFinder.AssemblyNames" /> are always investigated.
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <returns>A list of assemblies that should be loaded by the AtiehJob factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into AtiehJob.
        /// </returns>
