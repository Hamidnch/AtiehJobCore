...
namespace AtiehJobCore.Core.Domain.Messages
{
    ...
    /// </summary>
    public partial class ContactAttribute : BaseMongoEntity, ILocalizedEntity, IAclSupported
    {
        ...
        {
            get => _contactAttributeValues ?? (_contactAttributeValues = new List<ContactAttributeValue>());
