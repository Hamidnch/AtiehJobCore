...
using System.Linq;
using Role = AtiehJobCore.Common.MongoDb.Domain.Users.Role;
using User = AtiehJobCore.Common.MongoDb.Domain.Users.User;
...
namespace AtiehJobCore.Services.MongoDb.Users
{
    public class UserService : IUserService
    {
        ...
        public User InsertGuestUser(string urlReferrer = "")
        {
            ...
            if (guestRole == null)
                throw new CustomException("'Guests' role could not be loaded");
        ...
        public void DeleteUserRole(Role userRole)
        {
            ...
            if (userRole.IsSystemRole)
                throw new CustomException("System role could not be deleted");
