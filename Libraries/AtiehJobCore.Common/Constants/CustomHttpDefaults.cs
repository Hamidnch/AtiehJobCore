namespace AtiehJobCore.Common.Constants
{
    /// <summary>
    /// Represents default values related to HTTP features
    /// </summary>
    public static partial class CustomHttpDefaults
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the name of a request item that stores the value
        /// that indicates whether the client is being redirected to a new location using POST
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "nch.IsPOSTBeingDone";
