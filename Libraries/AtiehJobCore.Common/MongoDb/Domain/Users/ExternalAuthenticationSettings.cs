...
namespace AtiehJobCore.Common.MongoDb.Domain.Users
{
    ...
    public class ExternalAuthenticationSettings : ISettings
    {
        ...
        /// In most cases we can skip email validation for Facebook or any other third-party external authentication plugins.
        /// I guess we can trust  Facebook for the validation.
        /// </summary>
